 ...
 */
 void nilTimer1Start(uint32_t cycles){
 // CPU cycles per time period.
   cycles *= (F_CPU / 1000000); // JFA 2020-12-27; save 4 bytes
// void nilTimer1Start(uint32_t microseconds){
// long cycles = (F_CPU / 1000000) * microseconds;
 
  nilTimer1Stop();
  
  //uint8_t tshift; // JFA 2020-12-27: restructured following code so tshift doesn't need to be declared
  if (cycles <= 0X10000) {
